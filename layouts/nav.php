<div class="row bg-dark text-uppercase">
  <div class="container">
    <span class="text-light" style="margin-left:10px; font-weight:bold; font-size:1 em">DERECHOS DE AUTOR: ITSUP 2023 - SENADI CERTIFICADO N° QUI-063670</span>
  </div>
</div>
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><img src="assets/img/itsup.png" alt="..." /></a>
      ...
      <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown1">
            ...
            <li><a class="dropdown-item" href="normativa-respuesta.php">Para la respuesta</a></li>
            <li><a class="dropdown-item" href="normativa-seguimiento.php">Para el seguimiento</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown2"> 
            ...
            <li class="dropdown-submenu">
              <a class="dropdown-item dropdown-toggle" href="tipos-investigacion.php">Tipo de Investigaci&oacute;n en Funci&oacute; del riesgo</a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="registro-estudio.php">Sin Riesgo <span style="font-size: 0.5em;" >(Art.43 ACUERDO N° 00005 - 2022 MSP)</span></a></li>
                <li><a class="dropdown-item" href="registro-riesgo.php">Riesgo Mínimo <span style="font-size: 0.5em;" >(Art.44 ACUERDO N° 00005 - 2022 MSP)</span></a></li>
                <li><a class="dropdown-item" href="registro-ensayo.php">Riesgo Mayor al Mínimo <span style="font-size:   0.5em" >(Art.45 ACUERDO N° 00005 - 2022 MSP)</span></a></li>
              </ul>
            </li>
        ...
        <li class="nav-item"><a class="nav-link" href="consultor-externo.php" style="font-size: 0.75em;">Consultores Externos</a></li>
